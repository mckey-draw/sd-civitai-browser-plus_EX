...
#        sha256_upper = sha256.upper()
        sha256_upper = str(sha256).upper()    # 安全に変換
...
#                                file_sha256 = file_sha256.upper()
                                file_sha256 = str(file_sha256).upper()    # 安全に変換
...
#                        sha256 = data['sha256'].upper()
                        sha256 = str(data['sha256']).upper()    # 安全に変換
            except Exception as e:
...
#                upper_value = value.upper()
                upper_value = str(value).upper()    # 安全に変換
...
#                    data['sha256'] = sha256.upper()
                    data['sha256'] = str(sha256).upper()    # 安全に変換
...
#                        sha256_hashes[os.path.basename(file_path)] = sha256.upper()
                        sha256_hashes[os.path.basename(file_path)] = str(sha256).upper()    # 安全に変換
                except Exception as e:
...
#        if file_sha256: file_sha256 = file_sha256.upper()
        if file_sha256: file_sha256 = str(file_sha256).upper()    # 安全に変換
...
#                if entry_sha256: entry_sha256 = entry_sha256.upper()
                if entry_sha256: entry_sha256 = str(entry_sha256).upper()    # 安全に変換
